...
plot = sns.relplot(x="Gen", y="Value", kind="line", hue="Pheno", hue_order = ["Contacts", "Matings"], style="Pop", palette = ["red", "green"], data=table, legend='brief')
sns.despine()
...
plot = sns.relplot(x="Gen", y="Value", kind="line", hue="Pheno", hue_order = ["Fertilised Migrations"], style="Pop", palette = ["green"], data=table, legend="brief")
sns.despine()
plot.fig.suptitle("Migration", y=1)
plot.set(xlabel="Generation")
plot.savefig("multiOutput/fertmigrations/sim{}.png".format(newFile), bbox_inches="tight")
"""
